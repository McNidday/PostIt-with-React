...
module.exports = {
    ...
    login: async function ({
        ...
        if (!user) {
            const error = new Error('No such user found in database');
            error.code = 404;
            throw error;
        }
    ...
    createPost: async function ({
        ...
        return {
            ...
            updatedAt: updatedAt.createdAt.toString()
        }
    },
    ...
    post: async function ({ id }, req) {
        ...
        if (!post){
            const error = new Error('No posts found bitch');
            error.code = 404;
            throw error;
        }
